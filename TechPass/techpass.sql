...
INSERT INTO `officers` (`officer_id`, `user_id`, `position`, `term_start`, `term_end`, `is_active`) VALUES
(4, 8, 'Administrator', '2025-11-26', NULL, 1);
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `face_id_path` varchar(255) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `users` (`id`, `stud_no`, `fname`, `lname`, `email`, `password`, `phone`, `year`, `program`, `status`, `created_at`, `updated_at`, `face_id_path`) VALUES
(8, '00-140196', 'tech', 'Pass', 'techpass01@gmail.com', '$2y$10$v0T19tPBv0VDRIjxf1yeC.pKpJ.75ijHv6BJrdsqj0pYAK4JklGJ2', '', 'Graduate', 'BS Information Technology', 'Active', '2026-05-01 01:38:21', '2026-05-01 01:38:21', NULL);
